...
Chapters 3 and 5 set up Buchanan and Tullock to talk about their subject — politics and conostitutions — using economic analysis. It may seem a bit dry and excessive but remember, in 1962 almost nobody else thought politics could (or should) be analyzed with economic tools and assumptions like self-interested behavior! You can skim these chapters mostly, but focus on chapter 6 more closely, this is their actual model.

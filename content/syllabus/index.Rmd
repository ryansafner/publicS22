...
<p style="text-align:center"><a target="_blank" href="/syllabus/syllabus-pdf.pdf"><span class="btn btn-primary btn-lg"><i class="fas fa-file-pdf"></i> Download PDF</a></span></br>**Last Updated**: December 28, 2021</p>
...
Your final course grade is the weighted average of the following assignments. You can find general descriptions for all the assignments on the [assignments page](http://publicS21.classes.ryansafner.com/assignments/) and more specific information and examples on each assignment's page on the [schedule page](http://publicS21.classes.ryansafner.com/schedule/). 
